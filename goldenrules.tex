...
\begin{document}
	...
	\begin{itemize}
		...
		\item Please make sure you don't extend your time slot.
		\item Leave some time for Q \&\ A after your talk! For the Q \&\ A  the Herald (Moderator) will come on Stage and moderate the Q \&\ A. 
		\item Once they are final, please upload them directly to the frab.cccv.de system or hand them in at the Speakers' Desk.
...
\begin{itemize}
	...
	\item Alle Vorträge werden gefilmt, gestreamt und hinterher veröffentlicht. Bitte wiederhole daher, während deines Talks, jede Frage und jeden \textit{sinnvollen} Kommentar (aus dem Publikum/Internet), der nicht in ein Mikrofon gesprochen wurde für die Aufzeichnung.
	...
	\item Sobald deine Vortragsslides fertig sind, lade diese bitte selbst ins frab.cccv.de, oder reiche diese bitte am Speakers' Desk ein. 
